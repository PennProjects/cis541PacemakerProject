...
int main() {
    ...
    int valueToSendToSlave = 8; // Starting value only, this increments
    ...
    while (1) {
        ...
        lcd.printf("Value sent :  %d ",valueToSendToSlave);
        lcd.printf("Return : %d\r", dataFromSlave);
        
        valueToSendToSlave = dataFromSlave/2;
